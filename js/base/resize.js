window.onload =
    function (x) {
        function w() {
            ...
            a / v > 750 && (a = 750 * v), <!---->
                x.rem = a / 15, <!--document.documentElement.getBoundingClientRect().width -->
                r.style.fontSize = x.rem + "px";//document.documentElement.style.fontSize =
        }
        ...
        x.dpr = v,
            x.addEventListener("resize",
                ...
                !1),
            x.addEventListener("pageshow",
                function (b) {
                    b.persisted && (clearTimeout(t), t = setTimeout(w, 300));
                },
                !1),
            "complete" === s.readyState ? s.body.style.fontSize = 12 * v + "px" : s.addEventListener("DOMContentLoaded",
                function () {
