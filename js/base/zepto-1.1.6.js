...
var clik = "click";
if(/ipad|iphone|android|ipod/i.test(ua)) {
    clik = "tap";
}
...
function checkWebp(callback) {
    ...
    var img = new Image();
    img.onload = function() {
        var isBool = img.width > 0 && img.height > 0;
        setIsSupport(isBool);
        if(isBool&&typeof callback=="function")
        {
            callback(isBool);
        }
    };
    ...
    img.src = "data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAsAAAABBxAREYiI/gcAAABWUDggGAAAADABAJ0BKgEAAQACADQlpAADcAD++5QAAA==";
}
...
var UA = window.navigator.userAgent;
var device = {
  isYifubao:UA.match(/snyifubao/i) ? true:false,
...
function _loadAsyncJsUrl(src,callback){
